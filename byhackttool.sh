...
# variables
    blink='\e[5m'
    setdir=$PWD
    version='BYHackTTool v1.2'

# help
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    echo ""
    echo -e "Default Kullanım İçin Dosyayı ${lightgreen}sudo bash byhackttool.sh$tp"
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red ByHack$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/ByHack$tp"
    echo -e $cyan"    Instagram           $white":" $red zaferhamzak@gmail.com$tp"
...
ctrl_c() {
echo -e "\n"
echo -e "[${blink}${yellow}*${tp}]$blue BYHackTTool Programini Tercih Ettiginiz Için Teşekkürler  {ᎩᎩᏋᏝᎧᎧᏇᎥᏕᎶᎧᎥᎴ} :)$tp"
exit 0
}
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red ByHackTTool$tp ${blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Github              $white":" $red https://github.com/ByHackTTool$tp ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red zaferhamza_krc$tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo "  ~~~~~~~~~~~~~~~~~~~~~ BCHackTool ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        echo ""
	...
	echo " [13] ✔ RED_HAWK              [14] ✔ Ghost" 
        echo " [x] ✔ Exit" 
        echo ""
        echo -ne "❨${red}BYHackTTool@ᎩᎩᏋᏝᎧᎧᏇᎥᏕᎶᎧᎥᎴ${tp}❩:(${blue}./BYHackTTool${tp})\n↳[${blink}${lightcyan}*${tp}]➢ " ; read option
        ...
        case "$option" in 
            ...
            x)
                clear
                cat banners/bcbanner
                echo " BYHackTTool Programini Tercih Ettiginiz Icin Tesekkurler {ᎩᎩᏋᏝᎧᎧᏇᎥᏕᎶᎧᎥᎴ} !!" 
                echo ""
                exit 0
                ;;
        esac
